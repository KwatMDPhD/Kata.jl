...
@option("--black-option", multiple=True, help="Options for black.")
@option("--version", is_flag=True, help="Show the version and exit.")
def command_line_interface(
    ipynb_file_paths, back_up, keep_output, black_option, version
):
    """
    ...
    for ipynb_file_path in ipynb_file_paths:
        ...
        clean_ipynb(ipynb_file_path, back_up, keep_output, black_option)
